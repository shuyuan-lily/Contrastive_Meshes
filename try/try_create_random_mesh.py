...
for f in lst_of_dir:
    ...
    classes = f
    if not os.path.exists(f"transformed_meshes/{classes}"):
        os.mkdir(f"transformed_meshes/{classes}")
    ...
    export_file_name = f"transformed_meshes/{classes}/random_{obj_file_index_obj}"

    # Getting the list of directories
    path = f"transformed_meshes/{classes}/" 
    dir = os.listdir(path)
